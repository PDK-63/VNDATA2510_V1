...
//     esp_err_t err = i2c_new_master_bus(&i2c_mst_config, &sht30->bus_handle);
//     if (err != ESP_OK) {
//         ESP_LOGE(TAG_SHT30, "Failed to create I2C master bus: %s", esp_err_to_name(err));
//         return init_error;
//     }
...
//     err = i2c_master_bus_add_device(sht30->bus_handle, &dev_cfg, &sht30->dev_handle);
//     if (err != ESP_OK) {
//         ESP_LOGE(TAG_SHT30, "Failed to add SHT30 device: %s", esp_err_to_name(err));
//         i2c_del_master_bus(sht30->bus_handle);
//         sht30->bus_handle = NULL;
//         return init_error;
//     }
...
//         err = i2c_master_bus_rm_device(sht30->dev_handle);
//         if (err != ESP_OK) {
//             ESP_LOGE(TAG_SHT30, "Failed to remove device: %s", esp_err_to_name(err));
//             return error;
//         }
//         sht30->dev_handle = NULL;
//     }

//     if (sht30->bus_handle != NULL) {
//         err = i2c_del_master_bus(sht30->bus_handle);
//         if (err != ESP_OK) {
//             ESP_LOGE(TAG_SHT30, "Failed to delete bus: %s", esp_err_to_name(err));
//             return error;
//         }
//         sht30->bus_handle = NULL;
//     }
...
// {
//     if (sht30 == NULL || sht30->dev_handle == NULL || command == NULL) {
//         return error;
//     }

//     esp_err_t err = i2c_master_transmit(sht30->dev_handle, command, CommandLength, -1);
//     if (err != ESP_OK) {
...
// {
//     if (sht30 == NULL || sht30->dev_handle == NULL || dataRec == NULL || len == 0) {
//         return error;
//     }

//     esp_err_t err = i2c_master_receive(sht30->dev_handle, dataRec, len, -1);
//     if (err != ESP_OK) {
