...
//     ESP_ERROR_CHECK(board_tca_set_pin_mode(1, false));   // false = output

//     while (1) {
//         ESP_ERROR_CHECK(board_tca_write_pin(1, true));
//         ESP_LOGI(TAG, "pin 2 -> ON");
//         vTaskDelay(pdMS_TO_TICKS(1000));

//         ESP_ERROR_CHECK(board_tca_write_pin(1, false));
//         ESP_LOGI(TAG, "pin 2 -> OFF");
//         vTaskDelay(pdMS_TO_TICKS(1000));
//     }
// }
...
//     while (1) {
//         printf("LED8 OFF\n");
//         tm1638_set_led8(&dev, TM1638_LED8_OFF);
//         vTaskDelay(pdMS_TO_TICKS(1000));

//         printf("LED8 RED\n");
//         tm1638_set_led8(&dev, TM1638_LED8_RED);
//         vTaskDelay(pdMS_TO_TICKS(1000));

//         printf("LED8 GREEN\n");
//         tm1638_set_led8(&dev, TM1638_LED8_GREEN);
//         vTaskDelay(pdMS_TO_TICKS(1000));

//         printf("LED8 BOTH\n");
//         tm1638_set_led8(&dev, TM1638_LED8_BOTH);
//         vTaskDelay(pdMS_TO_TICKS(1000));
//     }
// }